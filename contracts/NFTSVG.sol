...
library NFTSVG {
        ...
        return
            string(
                abi.encodePacked(
                    ...
                    generateSVGCardMantle(params.name, params.symbol, params.tokenId.toString()),
                    generateSVGPositionDataAndLocationCurve(params.tokenId.toString()),
    ...
    function isRare() internal pure returns (bool) {
        return true;
    }
}